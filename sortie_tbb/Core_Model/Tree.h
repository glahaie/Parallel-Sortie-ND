...
class clTree {
  ...
  *
  * @param iCode Data member code.
  * @param p_cValHolder Variable into which to place the value.
  */
  ...
  * @param iNumChars Number of chars this tree will have.
  ...
  */
  clTree(int iType, int iSpecies, int iNumFloats, int iNumInts, int iNumChars,
  ...
  */
  ...
  char **mp_cCharValues; /**<Array of char data members*/
