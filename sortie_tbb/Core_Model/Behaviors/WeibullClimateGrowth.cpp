  ...
  clGrowthBase( p_oSimManager )
{
  ...
  {
    //Set namestring
    strcpy( m_cNameString, "WeibullClimategrowthshell" );
  ...
  catch ( ... )
  {
    ...
    strcpy( stcErr.cFunction, "clWeibullClimateGrowth::clWeibullClimateGrowth" );
    throw( stcErr );
  }
}
    ...
    for ( i = 0; i < m_iNumSpeciesTypeCombos; i++ )
      if ( clTreePopulation::sapling != mp_whatSpeciesTypeCombos[i].iType
           && clTreePopulation::adult != mp_whatSpeciesTypeCombos[i].iType )
           {
             ...
             strcpy( stcErr.cFunction, "clWeibullClimateGrowth::ReadParameterFile" );
...
void clWeibullClimateGrowth::ValidateData()
{
  ...
  {
    strcpy( err.cFunction, "clWeibullClimateGrowth::ValidateData" );
  ...
  catch ( ... )
  {
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy( stcErr.cFunction, "clWeibullClimateGrowth::ValidateData" );
    throw( stcErr );
  }
}
...
void clWeibullClimateGrowth::DoShellSetup( xercesc::DOMDocument * p_oDoc )
{
  ...
  catch ( ... )
  {
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy( stcErr.cFunction, "clWeibullClimateGrowth::DoShellSetup" );
    throw( stcErr );
  }
}
...
// SetNameData()
//////////////////////////////////////////////////////////////////////////////
void clWeibullClimateGrowth::SetNameData( char * cNameString )
{
  try
  {

    //Check the string passed and set the flags accordingly
    if ( strcmp( "WeibullClimateGrowth", cNameString ) == 0 )
    {
      m_iGrowthMethod = diameter_auto;
    }
    else if ( strcmp( "WeibullClimateGrowth diam only", cNameString ) == 0 )
    {
    ...
    else
    {
      ...
      strcpy( stcErr.cFunction, "clWeibullClimateGrowth::SetNameData" );
      throw( stcErr );
    }
  }
  catch ( modelErr & err )
...
float clWeibullClimateGrowth::CalcDiameterGrowthValue( clTree * p_oTree, clTreePopulation * p_oPop, float fHeightGrowth )
{
  ...
  catch ( ... )
  {
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy( stcErr.cFunction, "clWeibullClimateGrowth::CalcDiameterGrowthValue" );
    throw( stcErr );
  }
}
...
void clWeibullClimateGrowth::PreGrowthCalcs( clTreePopulation * p_oPop )
{
  ...
  catch ( ... )
  {
    ...
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy( stcErr.cFunction, "clWeibullClimateGrowth::PreCalcGrowth" );
    throw( stcErr );
  }
}
