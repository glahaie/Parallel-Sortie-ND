...
clInsectInfestation::clInsectInfestation( clSimManager * p_oSimManager ) : clWorkerBase( p_oSimManager ), clBehaviorBase( p_oSimManager )
{
  ...
  {
    //Set the namestring
    strcpy( m_cNameString, "InsectInfestation" );
  ...
  catch ( ... )
  {
    ...
    strcpy( stcErr.cFunction, "clInsectInfestation::clInsectInfestation" );
    throw( stcErr );
  }
}
...
void clInsectInfestation::Action()
{
  ...
  catch ( ... )
  {
    ...
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy( stcErr.cFunction, "clInsectInfestation::Action" );
    throw( stcErr );
  }
}
  ...
  for ( i = 0; i < m_iNumSpeciesTypeCombos; i++ )
  {
    ...
    if ( clTreePopulation::adult != mp_whatSpeciesTypeCombos[i].iType
         ...
         && clTreePopulation::snag != mp_whatSpeciesTypeCombos[i].iType )
         {
           ...
           modelErr stcErr;
           strcpy( stcErr.cFunction, "clInsectInfestation::RegisterTreeDataMembers" );
