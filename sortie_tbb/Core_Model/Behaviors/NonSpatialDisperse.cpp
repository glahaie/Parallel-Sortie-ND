  ...
  clWorkerBase( p_oSimManager ), clBehaviorBase( p_oSimManager ), clDisperseBase( p_oSimManager )
{
  try
  {
    strcpy( m_cNameString, "NonSpatialDisperse" );
  ...
  catch ( ... )
  {
    ...
    strcpy( stcErr.cFunction, "clNonSpatialDispersal::clNonSpatialDispersal" );
    throw( stcErr );
  }
}
...
void clNonSpatialDispersal::DoShellSetup( DOMDocument * p_oDoc )
{
  ...
  catch ( ... )
  {
    ...
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy( stcErr.cFunction, "clNonSpatialDispersal::DoShellSetup" );
    throw( stcErr );
  }
}
...
void clNonSpatialDispersal::AddSeeds()
{
  ...
  catch ( ... )
  {
    ...
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy( stcErr.cFunction, "clNonSpatialDispersal::AddSeeds" );
    throw( stcErr );
  }
}
