...
clGrowthBase::clGrowthBase(clSimManager *p_oSimManager) :
  ...
  try {
    ...
    strcpy(stcErr.cFunction, "clGrowthBase::clGrowthBase");
    throw(stcErr);
  }
}
//---------------------------------------------------------------------------
...
void clGrowthBase::Action() {
  try {
    ...
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy(stcErr.cFunction, "clGrowthBase::Action");
    throw(stcErr);
  }
}
//---------------------------------------------------------------------------
...
void clGrowthBase::RegisterTreeDataMembers()
{
  ...
  catch ( ... )
  {
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy( stcErr.cFunction, "clGrowthBase::RegisterTreeDataMembers" );
    throw( stcErr );
  }
}
