...
clPRSemiStochGrowth::clPRSemiStochGrowth( clSimManager * p_oSimManager ) :
  ...
  try
  {
    ...
    strcpy( m_cNameString, "prsemistochgrowthshell" );
  ...
  catch ( ... )
  {
    ...
    strcpy( stcErr.cFunction, "clPRSemiStochGrowth::clPRSemiStochGrowth" );
    throw( stcErr );
  }
}
...
void clPRSemiStochGrowth::DoShellSetup( DOMDocument * p_oDoc )
{
  ...
  catch ( ... )
  {
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy( stcErr.cFunction, "clPRSemiStochGrowth::DoShellSetup" );
    throw( stcErr );
  }
}
...
float clPRSemiStochGrowth::CalcDiameterGrowthValue( clTree * p_oTree, clTreePopulation * p_oPop, float fHeightGrowth )
{
  ...
  catch ( ... )
  {
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy( stcErr.cFunction, "clPRSemiStochGrowth::CalculateFunctionValue" );
    throw( stcErr );
  }
}
