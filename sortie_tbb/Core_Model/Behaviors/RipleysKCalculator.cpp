...
clRipleysKCalculator::clRipleysKCalculator( clSimManager * p_oSimManager ) : clWorkerBase( p_oSimManager ), clBehaviorBase( p_oSimManager )
{
  ...
  catch ( ... )
  {
    ...
    strcpy( stcErr.cFunction, "clRipleysKCalculator::clRipleysKCalculator" );
    throw( stcErr );
  }
}
...
void clRipleysKCalculator::GetData( xercesc::DOMDocument * p_oDoc )
{
  ...
  catch ( ... )
  {
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy( stcErr.cFunction, "clRipleysKCalculator::GetData" );
    throw( stcErr );
  }
}
...
void clRipleysKCalculator::GetParameterFileData( xercesc::DOMDocument * p_oDoc )
{
  ...
  catch ( ... )
  {
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy( stcErr.cFunction, "clRipleysKCalculator::GetParameterFileData" );
    throw( stcErr );
  }
}
...
void clRipleysKCalculator::Action()
{
  ...
  catch ( ... )
  {
    ...
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy( stcErr.cFunction, "clRipleysKCalculator::Action" );
    throw( stcErr );
  }
}
