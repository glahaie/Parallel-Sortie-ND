...
clPowerHeightGrowth::clPowerHeightGrowth(clSimManager * p_oSimManager) :
  ...
  try {
    ...
    strcpy(m_cNameString, "powergrowthshell");
    ...
    strcpy(stcErr.cFunction, "clPowerHeightGrowth::clPowerHeightGrowth");
    throw(stcErr);
  }
}
...
void clPowerHeightGrowth::DoShellSetup(DOMDocument * p_oDoc) {
  ...
  try {
    ...
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy(stcErr.cFunction, "clPowerHeightGrowth::GetNameData");
    throw(stcErr);
  }
}
