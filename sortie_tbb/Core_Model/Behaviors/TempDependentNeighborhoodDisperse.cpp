  ...
  clWorkerBase( p_oSimManager ), clBehaviorBase( p_oSimManager ), clDisperseBase( p_oSimManager )
{
  try
  {
    strcpy( m_cNameString, "TemperatureDependentNeighborhoodDisperse" );
  ...
  catch ( ... )
  {
    ...
    strcpy( stcErr.cFunction, "clTempDependentNeighborhoodDisperse::clTempDependentNeighborhoodDisperse" );
    throw( stcErr );
  }
}
...
void clTempDependentNeighborhoodDisperse::DoShellSetup( DOMDocument * p_oDoc )
{
  ...
  catch ( ... )
  {
    ...
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy( stcErr.cFunction, "clTempDependentNeighborhoodDisperse::DoShellSetup" );
    throw( stcErr );
  }
}
...
void clTempDependentNeighborhoodDisperse::AddSeeds()
{
  ...
  catch ( ... )
  {
    ...
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy( stcErr.cFunction, "clTempDependentNeighborhoodDisperse::AddSeeds" );
    throw( stcErr );
  }
}
