...
clLightBase::clLightBase( clSimManager * p_oSimManager ) : clWorkerBase( p_oSimManager ), clBehaviorBase( p_oSimManager )
{
  ...
  catch ( ... )
  {
    ...
    strcpy( stcErr.cFunction, "clLightBase::clLightBase" );
    throw( stcErr );
  }
}
...
void clLightBase::GetData( xercesc::DOMDocument * p_oDoc )
{
  ...
  catch ( ... )
  {
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy( stcErr.cFunction, "clLightBase::GetData" );
    throw( stcErr );
  }
}
...
void clLightBase::Action()
{
  ...
  catch ( ... )
  {
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy( stcErr.cFunction, "clLightBase::Action" );
    throw( stcErr );
  }
}
...
void clLightBase::RegisterTreeDataMembers()
{
  ...
  catch ( ... )
  {
    modelErr stcErr;
    stcErr.iErrorCode = UNKNOWN;
    strcpy( stcErr.cFunction, "clLightBase::RegisterTreeDataMembers" );
    throw( stcErr );
  }
}
...
/*        fstream brightness("GLI Brightness array.xls", ios::trunc | ios::out); brightness << "Segment";
  ...
  {
    modelErr stcErr;
    strcpy( stcErr.cFunction, "clLightBase::PopulateBrightnessArray" );
    stcErr.iErrorCode = UNKNOWN;
    throw( stcErr );
  }
}
