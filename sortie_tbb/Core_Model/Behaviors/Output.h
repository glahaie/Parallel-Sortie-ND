...
class clOutput : public clBehaviorBase {
  ...
  */
  struct stcTreeOutputInfo {
   ...
   short int iNumChars;      /**<How many char data members we're saving for*/
   ...
   short int *p_iCharCodes;  /**<Codes for char data members*/
  ...
  */
  struct stcGridOutputInfo {
   ...
   short int iNumChars;            /**<How many char data members we're saving*/
   ...
   short int iNumPackageChars;     /**<How many package char data members*/
   ...
   short int *p_iPackageCharCodes; /**<Codes for package char data members*/
