...
class clTreePopulation : public clPopulationBase {
  ...
  friend class clTestTreePopulation2; /**<For testing purposes*/
  ...
  *
  * @param args String with query terms for the search.
  ...
  */
  clTreeSearch* Find(const char *args);
  ...
  */
  ...
  /**
  * Translates a species name string into its code.  This is useful when
  * parsing the XML file.
  *
  * @param cSpeciesName Species name to translate.
  * @return Code of the species, or -1 if the species isn't recognized.
  */
  short int TranslateSpeciesNameToCode(const char *cSpeciesName);
  ...
  * recognized.
  */
  const char* TranslateSpeciesCodeToName(int iSpecies);
  ...
  *
  * @param cLabel The name of the new data member - keep it short.
  ...
  */
  short int RegisterInt(const char *cLabel, int iSpecies, int iType);
  ...
  * @throw ILLEGAL_OP error if there is no more space for new data members.
  */
  short int RegisterFloat(const char *cLabel, int iSpecies, int iType);
  ...
  * @throw ILLEGAL_OP error if there is no more space for new data members.
  */
  short int RegisterChar(const char *cLabel, int iSpecies, int iType);
  ...
  * @throw ILLEGAL_OP error if there is no more space for new data members.
  */
  short int RegisterBool(const char *cLabel, int iSpecies, int iType);
  ...
  */
  short int GetIntDataCode(const char *cLabel, int iSpecies, int iType);
  ...
  * @throw An error if an unrecognized species or type is passed.
  */
  short int GetFloatDataCode(const char *cLabel, int iSpecies, int iType);

  /**
  * Gets the data code for accessing a char tree data member.  This code can be
  ...
  * @throw An error if an unrecognized species or type is passed.
  */
  short int GetCharDataCode(const char *cLabel, int iSpecies, int iType);
  ...
  * @throw An error if an unrecognized species or type is passed.
  */
  short int GetBoolDataCode(const char *cLabel, int iSpecies, int iType);
  ...
  * @throw An error if an unrecognized species or type is passed.
  */
  const char* GetIntDataLabel(short int iCode, int iSpecies, int iType);
  ...
  * @throw An error if an unrecognized species or type is passed.
  */
  const char* GetFloatDataLabel(short int iCode, int iSpecies, int iType);

  /**
  * Gets the label for a char tree data member. This function will not be
  * responsible for duplicate labels.
  *
  * @param iCode The data member's label.
  * @param iSpecies The species.
  ...
  * @throw An error if an unrecognized species or type is passed.
  */
  const char* GetCharDataLabel(short int iCode, int iSpecies, int iType);
  ...
  * @throw An error if an unrecognized species or type is passed.
  */
  const char* GetBoolDataLabel(short int iCode, int iSpecies, int iType);
...
///////////////////////////////////////////////////////////////////////////
  ...
  bool bDoUpdates; /**<Whether or not to sort the hash table when DoDataUpdates
                   is called.*/
  ...
  short int **mp_iNumTreeFloatVals; /**<Number of tree float data members that
        have been defined for this run.  Array size is number of species by
        number of types.*/
  short int **mp_iNumTreeCharVals; /**<Number of tree char data members that
        have been defined for this run.  Array size is number of species by
        number of types.*/
  ...
  char ****mp_cIntLabels; /**<List of tree integer data member labels.  Array
        size is number of species by number of types by number of integer data
        members.  The code for a data member equals the third array index.*/
  char ****mp_cFloatLabels; /**<List of tree float data member labels.  Array
        size is number of species by number of types by number of integer data
        members.  The code for a data member equals the third array index.*/
  char ****mp_cCharLabels; /**<List of tree char data member labels.  Array
        size is number of species by number of types by number of integer data
        members.  The code for a data member equals the third array index.*/
  char ****mp_cBoolLabels; /**<List of tree bool data member labels.  Array
        size is number of species by number of types by number of integer data
        members.  The code for a data member equals the third array index.*/
  ...
  */
   ...
   * @param cLabel Name of the new data member.  Keep it short.
   ...
   * @param p_cLabels Pointer to the correct mp_c[x]Labels array
   ...
   */
  short int RegisterDataMember(const char *cLabel, int iSpecies, int iType,
   short int **p_iNumTreeVals, char ****p_cLabels);
  ...
  struct speciesCodes {unsigned short int iCode; /**<Species code*/
                       char cName[MAX_SPECIES_NAME_SIZE]; /**<Species name string*/
                       };
  ...
  */
   ...
   * @param p_oTree The tree to be updated.
   * @param iCode The data member code - as passed to the tree.
   * @param cValue The new value - as passed to the tree.
   * @throws modelErr if the code is invalid.
   */
  void UpdateTree(clTree *p_oTree,short int iCode,const char *cValue);
