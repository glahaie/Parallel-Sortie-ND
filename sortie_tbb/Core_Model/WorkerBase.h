...
/**
  Gets the object's namestring.  This name can be used to search for the object.

  @return Namestring.
*/
  char* GetName() {return m_cNameString;};
...
//  virtual void WriteCommandHelp(char *cCommand){;};
  ...
  protected:
  char m_cNameString[MAX_NAMESTRING_SIZE]; /**<Object's identifying namestring.*/
  static clSimManager *mp_oSimManager; /**<Pointer to the simulation manager
