...
/**
  Constructor.  This constructor structure makes sure that there's no default constructor
...
/**
  ...
  @return clGridManager class version number.
*/
...
/**
  ...
  @param iNumIntVals Number of integer data members in a grid cell record.  Can be 0.
  @param iNumFloatVals Number of float data members in a grid cell record.  Can be 0.
  @param iNumCharVals Number of char data members in a grid cell record.  Can be 0.
  @param iNumBoolVals Number of bool data members in a grid cell record.  Can be 0.
  @param fXCellLength The length of a grid cell in the X direction, in meters.  Not
        required.  If ommitted this will default to the plot's cell length.
  @param fYCellLength The length of a grid cell in the Y direction, in meters.  Not
        required.  If this is ommitted (i.e. = 0), it is assumed the grid cells
